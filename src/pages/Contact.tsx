...
const ContactItem = styled.a`display: flex; align-items: center; gap: 1rem; padding: 1rem; background: ${({ theme }) => theme.colors.secondary}80; border-radius: ${({ theme }) => theme.radii.xl}; transition: background ${({ theme }) => theme.transitions.normal}; justify-content: center; @media (min-width: ${({ theme }) => theme.breakpoints.lg}) { justify-content: flex-start; } &:hover { background: ${({ theme }) => theme.colors.secondary}; }`;
...
const QuickCallCTA = styled.div`background: ${({ theme }) => theme.gradients.hero}; border-radius: ${({ theme }) => theme.radii['2xl']}; padding: 2rem; text-align: center; display: flex; flex-direction: column; align-items: center; width: 100%; box-sizing: border-box; margin: 0 auto;`;
